...
const menuSections: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Compras', icon: Tags },
    ],
  },
  {
    title: 'Sistema',
    items: [
      { label: 'Configurações', icon: Wrench },
    ],
  },
];
              ...
              {section.items.map(({ label, icon: Icon }) => {
                ...
                return (
                  <button
                    ...
                    className={`group flex w-full items-center rounded-xl py-3 text-left text-sm font-semibold transition-all duration-200 ${
                      isCollapsed
                        ? 'justify-center px-2'
                        : 'gap-3 px-4'
                    } ${
